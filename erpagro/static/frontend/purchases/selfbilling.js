...
document.addEventListener("DOMContentLoaded", () => {
    ...
    let invoice_pdf_anchor  = document.querySelector("#invoice-pdf-anchor")
    ...
    function compute_total_amount_text() {
        ...
        total_amount_text.innerHTML = `Base Imponible Factura: ${total.toLocaleString("es", number_options)} €`;
    }
