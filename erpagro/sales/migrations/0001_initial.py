    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('net_weight', models.DecimalField(decimal_places=1, max_digits=9, verbose_name='peso neto')),
                ('price_per_kg', models.DecimalField(blank=True, decimal_places=2, max_digits=5, null=True, verbose_name='precio por kg')),
                ...
                ('packaging', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='sales', to='packaging.packaging', verbose_name='envase')),
            ],
            options={
                'verbose_name': 'Salida',
            },
